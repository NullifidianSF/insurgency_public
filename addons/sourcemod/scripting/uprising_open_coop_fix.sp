...
public void OnMapStart()
{
	...
	g_bAllowedMap = StrEqual(map, "uprising_open_coop", false);
	if (!g_bAllowedMap) {
...
{
	ServerCommand("sm plugins unload disabled/uprising_open_coop_fix");
	return Plugin_Stop;
}
